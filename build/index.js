...
const RegenerateThumbnails = () => {
  ...
  const processBatches = async (allIds, currentIndex, currentStats, startTime) => {
    ...
    if (currentIndex >= allIds.length) {
      ...
      setNotice({
        type: 'success',
        message: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.sprintf)((0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)('Successfully regenerated thumbnails for %d images in %d seconds.', 'craftsman-suite'), currentStats.completed, duration)
      });
      return;
    }
  ...
  const renderSettings = () => (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.PanelBody, {
    ...
    min: 1,
    max: 50,
    help: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)('Low (1–10) for shared hosting, High (20+) for dedicated servers.', 'craftsman-suite')
  }))), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "grid grid-cols-1 md:grid-cols-3 gap-6 p-6 items-start"
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "md:col-span-1"
  ...
  const renderProgress = () => {
    ...
    return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.Card, {
      ...
      className: "ml-2 text-sm text-gray-500"
    }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)('items', 'craftsman-suite')))))), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.CardFooter, {
      ...
      variant: "primary",
      onClick: () => window.location.href = window.craftsmanSuiteData.admin_url + 'upload.php'
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...
    className: "text-[13px] text-wp-sub leading-relaxed max-w-4xl"
  }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)('This tool regenerates thumbnails for all image attachments. This is useful if you have changed your theme or one of your thumbnail dimensions.', 'craftsman-suite'))), notice && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.Notice, {
    status: notice.type,
    onRemove: () => setNotice(null),
    className: "mb-4"
  }, notice.message), view === 'settings' ? renderSettings() : renderProgress());
};
...
const App = () => {
  ...
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("p", null, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)('Powered by passion and lots of coffee.', 'craftsman-suite'), "\xA0", (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("a", {
